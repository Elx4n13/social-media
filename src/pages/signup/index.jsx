...
export default function SignUp() {
  ...
  const onFinish = (values) => {
    ...
    if(checkNick === 'Boshluq'){
      ...
      const [nickName,name,surName ,email, password, bio,image] = [newData.nickname.toLowerCase(),newData.name,newData.surname,newData.email.toLowerCase(),newData.password,newData.bio,newData.image]
      signUp({nickName,name,surName,email,password,bio,image})
      router.push('/login')
    }
    else{
